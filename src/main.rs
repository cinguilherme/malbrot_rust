...
/// Try to find if C is part of the malbrot set
fn scape_time(c: Complex<f64>, limit: usize) -> Option<usize> {
...
fn test_parse_complex() {
    ...
    assert_eq!(parse_complex(",-0625"), None)
}
...
fn pixel_to_point(bounds: (usize, usize),
    ...
    Complex {
        ...
        im: upper_left.im - pixel.1 as f64 * heigh / bounds.1 as f64
    }
}
